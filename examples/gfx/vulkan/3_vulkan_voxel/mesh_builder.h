...
std::vector<Vertex> QUAD_MESH_DOWN_VERTEX_DATA = {
    {{ 0.5f, -0.5f,  0.5f},  {1.0f, 0.0f, 1.0f},  {1.0f, 1.0f}, 0},
    {{-0.5f, -0.5f,  0.5f},  {1.0f, 0.0f, 1.0f},  {1.0f, 0.0f}, 0},
    {{-0.5f, -0.5f, -0.5f},  {1.0f, 0.0f, 1.0f},  {0.0f, 0.0f}, 0},
    {{ 0.5f, -0.5f, -0.5f},  {1.0f, 0.0f, 1.0f},  {0.0f, 1.0f}, 0} 
};

std::vector<Vertex> QUAD_MESH_LEFT_VERTEX_DATA = {
    {{0.5f,  0.5f,  0.5f},  {1.0f, 0.0f, 1.0f},  {1.0f, 1.0f}, 1},
