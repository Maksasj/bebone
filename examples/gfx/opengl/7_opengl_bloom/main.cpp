...
int main() {
    ...
    while (!window->closing()) {
        ...
        geometry_fbo.bind();
            ...
            main_program.enable();
            main_program.set_uniform("transform", transform.final_matrix());
            main_program.set_uniform("cam", camera);
        ...
        geometry_texture.bind_texture_unit(0);
