...
namespace bebone::gfx {
    ...
    ) : VulkanWrapper<VkRenderPass>(device), attachments(attachments), depth_attachment_index(0), has_depth_attachment_flag(false), color_attachment_count(0), extent(extent) {
